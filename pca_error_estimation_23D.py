...
#Data input
pcaScores = pd.read_csv("Output/Resultados/23D/pcaScores23D.csv")
...
for i in range(0, pcaScores.shape[1]):
    ...
    with open("Input/23D/PCA/PC_"+str(i+1)+".pickle", "rb") as pcaFile:
...
# pcaMean.to_csv("Output/Resultados/23D/pcaMean23D.csv")
# pcaStd.to_csv("Output/Resultados/23D/pcaStd23D.csv")
